...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        ...
        question = 'What is Lady Gaga real name?'
        answer = 'Stefania Germanotta'
    ...
    def test_delete_question_404(self):
        response = self.client().delete('/questions/4200')
        data = json.loads(response.data)
    ...
    #test if the question creation fails 
    ...
    def test_search_without_results(self):
        response = self.client().post('/questions', json={'searchTerm':'ffff'})
    ...
    #test get questions per category for this i used the category with id=3
    def test_get_questions_per_category(self):
     ...
     # test questions_by_category get 404
    ...
    # test quiz
    def test_quiz(self):
        quiz_round = {'previous_questions': [], 'quiz_category': {'type': 'Art', 'id': 1}}
     ...
     #testing the quiz playing without sending the category 
